...
import { incrementItemAction, decrementItemAction } from '../../../../store/cartReducer'
    ...
    <section className={s.item}>
      ...
      <div className={s.info}>
        <div className={s.count}>
          <button onClick={incItem} className={s.button}> + </button> 
          <div className={s.counter}>{ count }</div> 
          <button onClick={decItem} className={s.button}> - </button>
        </div>
